...
@Mod(Palletable.MODID)
public class Palletable {
    public static final String MODID = "palletable";
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> PALETTE_TAB =
            CREATIVE_MODE_TABS.register("palletable", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.palletable"))
                    .icon(() -> PALETTE.get().getDefaultInstance())
                    .displayItems((parameters, output) -> output.accept(PALETTE.get()))
                    .build());

    public Palletable(IEventBus modEventBus, ModContainer modContainer) {

...
public final class PaletteGuiSettings {
    ...
    private static Path file() {
        return FMLPaths.GAMEDIR.get().resolve("palletable").resolve("gui_settings.json");
    }
    ...
    public static PaletteGuiSettings load() {
        ...
        try (Reader reader = Files.newBufferedReader(path)) {
            ...
            Palletable.LOGGER.warn("Failed to load palette GUI settings", e);
            return new PaletteGuiSettings();
        }
    }
    ...
    public static void save(PaletteGuiSettings settings) {
        ...
        try {
            ...
            Palletable.LOGGER.warn("Failed to save palette GUI settings", e);
        }
    }
}
